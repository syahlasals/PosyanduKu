        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col">
                            <a href="{{ url('pengelola/dataImunisasi') }}" class="card card-ap">
                                <div class="card-body">
                                    <span class=" d-flex align-items-center justify-content-center mb-3 text-center"><b>Jumlah
                                            Anak <br> Terdaftar</b></span>
                    ...
                    <a href="{{ url('pengelola/dataImunisasi/obesitas/print') }}" class="btn btn-primary"
                        target="_blank">Print Rekap Anak</a><br><br>
                    ...
                    @endforeach
                                    ...
                                    <td>
                                        <a href="history/{{ $data->nik_anak }}"><button type="button"
                    ...
                    <a href="{{ url('pengelola') }}" class="btn btn-main" role="button"
