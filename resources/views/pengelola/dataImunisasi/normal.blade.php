...
<body id="page-top">
    ...
    <div class="container-fluid">
        ...
        <a href="{{ url('/pengelola/dataImunisasi/normal/print') }}" class="btn btn-main" target="_blank" role="button" aria-disabled="true">Cetak Rekap Anak <i class="fa-solid fa-print ml-1"></i></a><br><br>
