            ...
            <tr>
                ...
                <div class="row d-flex">
                    <div class="col-14">
                        ...
                        <a href="/entry/statusPenyimpangan/{{$anak->nik_anak}}"><button type="button" class="btn btn-primary" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Status Penyimpangan"><i class="fa-regular fa-person-arrow-down-to-line"></i></button></a>
